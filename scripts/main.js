...
function filtrarPorNomeOuFone(data, filtro) {
    ...
    return data.filter((usuario) => expReg.test(`${usuario.nome}`));
}
...
// inserir usuarios
function insertUsuario(nome, senha, salario) {
    if (!nome || !senha || !salario) {
...
// editar usuarios
function editUsuario(id, nome, senha, salario) {
...
function submeter(e) {
    ...
    if (id) {
        editUsuario(id, nome, senha, salario);
    } else {
        insertUsuario(nome, senha, salario);
    }
